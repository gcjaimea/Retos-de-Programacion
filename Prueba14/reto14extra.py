...
print(f"Fecha Cumpleaños sin formatear: {fecha_cumpleaños}")
print(f"Fecha Cumpleaños formateada1 : {fecha_cumpleaños_formateada1}")
print(f"Fecha Cumpleaños formateada2 : {fecha_cumpleaños_formateada2}")
print(f"Fecha Cumpleaños formateada3 : {fecha_cumpleaños_formateada3}")
print(f"Fecha Cumpleaños formateada4 : {fecha_cumpleaños_formateada4}")
print(f"Fecha Cumpleaños formateada5 : {fecha_cumpleaños_formateada5}")
print(f"Fecha Cumpleaños formateada6 : {fecha_cumpleaños_formateada6}")
print(f"Fecha Cumpleaños formateada7 : {fecha_cumpleaños_formateada7}")
print(f"Fecha Cumpleaños formateada8 : {fecha_cumpleaños_formateada8}")
print(f"Fecha Cumpleaños formateada9 : {fecha_cumpleaños_formateada9}")
print(f"Fecha Cumpleaños formateada10 : {fecha_cumpleaños_formateada10}")
